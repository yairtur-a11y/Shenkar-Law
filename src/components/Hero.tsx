...
export default function Hero({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="relative flex min-h-screen items-end overflow-hidden" dir={ui.dir}>
      <Image src="/hero-bg.jpg" alt="City skyline" fill priority sizes="100vw" className="object-cover" />
      ...
      <div className="container relative z-10 pb-[15vh]">
        ...
        <h1 className="fade-up m-0 max-w-3xl font-display text-[clamp(58px,9vw,116px)] font-light leading-none tracking-[-.03em] text-ivory">{ui.firm}</h1>
        <p className="fade-up mt-3 font-display text-[clamp(22px,3vw,34px)] font-light tracking-[.05em] text-stone">{ui.descriptor}</p>
      </div>
    </section>
  );
}
